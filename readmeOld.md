...
```php
'providers' => [
    Transmissor\MessengerServiceProvider::class,
],
```
...
```
php artisan vendor:publish --provider="Transmissor\MessengerServiceProvider" --tag="config"
```
...
```
php artisan vendor:publish --provider="Transmissor\MessengerServiceProvider" --tag="migrations"
```
