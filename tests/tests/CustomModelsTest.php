...
use Transmissor\Tests\Stubs\Models\CustomMessage;
use Transmissor\Tests\Stubs\Models\CustomParticipant;
use Transmissor\Tests\Stubs\Models\CustomThread;

class CustomModelsTest extends TestCase
{
    public function test_it_can_use_custom_message_model()
    {
    ...
    public function test_it_can_use_custom_participant_model()
    {
    ...
    public function test_it_can_use_custom_thread_model()
    {
    ...
    public function test_it_can_use_custom_table()
    {
        $this->setMessageCustomModel();
    ...
    public function test_it_should_return_custom_name_when_not_available()
    {
    ...
    public function test_it_can_get_custom_model_table_property()
    {
        $this->setMessageCustomModel();
        $this->setMessageCustomTable();
